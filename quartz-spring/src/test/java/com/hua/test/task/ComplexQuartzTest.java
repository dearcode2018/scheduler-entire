...
@ContextConfiguration(locations = {
		...
		"classpath:conf/xml/spring-schedule.xml", 
		"classpath:conf/xml/complex-quartz.xml"})
public final class ComplexQuartzTest extends BaseTest {
